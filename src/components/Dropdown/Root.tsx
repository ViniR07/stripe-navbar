...
export const DropdownRoot: React.FC = () => {
  ...
  if (
    cachedOption?.contentDimensions?.width &&
    cachedOption?.contentDimensions?.height
  ) {
      ...
      >
        <motion.div
          ...
          transition={{
            ...
            width: {
              duration: isFirstInteraction ? 0 : refDuration * 0.8,
            },
            height: {
              duration: isFirstInteraction ? 0 : refDuration * 0.8,
            },
...
const DropdownArrow: React.FC<{ isFirstInteraction: boolean }> = ({
  isFirstInteraction,
}) => {
